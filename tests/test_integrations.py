...
def test_read_tab_returns_csv_the_typescript_parser_can_split(sheet):
    ...
    # QA-08 lives in the browser download and in RAW cell writes, not here: this CSV only feeds
    # lib/import.ts, and a guard here mangled `+91` phone numbers on a live Sheets pull.
    assert SH.to_csv([["+91 98100 11223", "=cmd|x"]]) == "+91 98100 11223,=cmd|x\r\n"
